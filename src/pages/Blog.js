  ...
  const [bloggers, setBloggers] = useState([
    {
      ...
      img: "https://business.bofa.com/content/dam/boamlimages/images/bofa-og-logo.jpg",
      ...
      link: "https://www.merrilledge.com/offers/investing-tools?cm_mmc=GWM-Edge-Int-_-Google-PS-_-index-funds-_-NB_Investing&ds_rl=8411&gclid=Cj0KCQjwlumhBhClARIsABO6p-zh3bvV6Vze0JqS5Cvf73dhD2StA2t9M0DlxSxAtAOZGJV-O9ycnk4aAnk1EALw_wcB&gclsrc=aw.ds",
    },
    {
      category: "Happy Money",
      img: "https://images.squarespace-cdn.com/content/v1/572fc6042b8dde9e10b6ea9d/1650103337037-DYVZVYTN1XWV385ZBAIC/Following-Mr-Money-Mustaches-Simple-Strategy-to-Financial-Freedom.jpg?format=1500w",
      title:
    ...
    },
    {
      ...
      img: "https://themillennialmoneywoman.com/wp-content/uploads/2021/02/sp500-process.png",
    ...
    <>
      <div className="selection">
         <div className="choose">
            <div className="blogSelect">Article : </div>
        ...
        <div>
          {getBloggersInCategory(category).map((blogger, index) => (
            <div className="blogger-card" key={index}>
              ...
              <div>
                <button
                  onClick={() => (window.location.href = blogger.link)}
                  className="readbtn"
                  > Read Article
                  </button>
              </div>
